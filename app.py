...
def text_to_examine():
    ...
    if request.method == 'POST':
        ...
        return render_template('index.html',
                                     ...
                                     words = textc,
                                     result=roundround((prediction) * 100, 2), absolutist = round((absolutist * 100), 2), sentiment = round((sentiments * 100),2), pronouns = round((pronoun * 100) ,2), fatigue = round((fatigue * 100), 2),
